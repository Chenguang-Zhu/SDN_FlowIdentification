...
def predict(X):
  ...
  k_means = mixture.GMM(n_components=8, covariance_type='full')
  k_means.fit(X)
...
if __name__ == '__main__':
  ...
  packets1 = strip(packets1,  54, 57 + e)
  ...
  packets2 = strip(packets2, 54, 57 + e)
  ...
  packets3 = strip(packets3, 42, 45 + e)
  ...
  packets4 = strip(packets4, 42, 45 + e)
